...
export default function BoardsAdmin() {
  ...
  // Supervisores disponibles en la empresa seleccionada
                ...
                <View style={{ ...card, gap: 12 }}>
                  ...
                  {showCreate && (
                      <View style={{ gap: 8 }}>
                        ...
                        >
                          <Picker
                              selectedValue={supervisorUserId}
                              onValueChange={(v) => setSupervisorUserId(String(v))}
                              dropdownIconColor={lokalyTheme.text}
                              style={{ color: lokalyTheme.text }}
                          >
                            <Picker.Item label="Sin supervisor" value="" />
                            {supervisors.map((s) => (
                                <Picker.Item
                                    key={s.id}
