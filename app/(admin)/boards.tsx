...
export default function BoardsAdmin() {
  ...
  const loadBoards = useCallback(async () => {
    ...
    try {
      const qs =
        ...
        `&orgId=${encodeURIComponent(selectedOrgId)}`; // ← obligatorio
  ...
  const TenantSelector = () => {
        ...
        <View style={{ minWidth: 260 }}>
          <label style={{ display: "flex", gap: 6, alignItems: "center" }}>
            ...
            <select
              ...
              style={{ padding: 10, borderRadius: 10, border: "1px solid #E5E7EB" as any, width: "100%" }}
            >
    ...
    return (
      <View style={{ borderWidth: 1, borderRadius: 10, borderColor: "#E5E7EB", minWidth: 220 }}>
        ...
        ListHeaderComponent={
          <View style={{ gap: 12 }}>
            ...
            <View style={{ ...card, gap: 10 }}>
              <Text style={{ fontWeight: "800" }}>Contexto</Text>
            ...
            <View style={{ ...card, padding: 12, flexDirection: "row", alignItems: "center", gap: 8 }}>
              <Text style={{ fontWeight: "800" }}>Colonias</Text>
          ...
          >
            {editingId === b.id ? (
              ...
              <>
                ...
                <Text>Condominio: {b.orgId}</Text>
                {!!b.description && <Text>Descripción: {b.description}</Text>}
                {!!b.createdAt && (
                  <Text style={{ color: "#64748B" }}>
                    Creado: {new Date(b.createdAt).toLocaleString()}
                  </Text>
                )}
                {!!b.updatedAt && (
                  <Text style={{ color: "#64748B" }}>
